...
<body>
	<div class="container col-md-6 pt-4">
			        ...
			        <table class="table text-left">
			            <tbody class="table-body">
			                <tr class="cell-1">           
			                    <td>ID</td>
			                    <td>:</td>
    							<td><input type="text" class="form-control" name="sign_name" id="sign_id" placeholder="예: 영문, 숫자"></td>
                            </tr>
                            <tr class="cell-1">       
                                <td>비밀번호</td>
                                <td>:</td>
			...
			<div class="text-center">
			        ...
			        <a href="#" id="individualSignUp"><button type="button" class="btn btn-primary">가입하기</button></a>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#individualSignUp").unbind("click").click(function(e) {
					e.preventDefault();
					fn_individualSignUp();
				});
			});
			 
			function fn_individualSignUp() {
