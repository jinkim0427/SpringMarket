...
<body>
			                ...
			                <tr class="cell-1">           
			                    <td>
                                	<div class="custom-control custom-checkbox">
    									...
    									<label class="custom-control-label" for="jb-checkbox-1">구매 회원 약관</label>
    								</div>
    							</td>
                            </tr>
                            <tr class="cell-1">           
			        ...
			        <table class="table text-left">
			            <tbody class="table-body">
                            ...
                            <tr class="cell-1">           
			                    <td>
                                	<div class="custom-control custom-checkbox">
    									<input type="checkbox" name="jb-checkbox" id="jb-checkbox-3" class="custom-control-input">
    									<label class="custom-control-label" for="jb-checkbox-3">쇼핑 이메일 수신</label>
    								</div>
    							</td>
                            </tr>
                            <tr class="cell-1">           
			                    <td>
                                	<div class="custom-control custom-checkbox">
    									<input type="checkbox" name="jb-checkbox" id="jb-checkbox-4" class="custom-control-input">
    									<label class="custom-control-label" for="jb-checkbox-4">쇼핑 SMS 수신</label>
    								</div>
    							</td>
                            </tr>
                        </tbody>
	...
	<script type="text/javascript">
		...
		function fn_moveToSignUpInfoIndividual() {
			window.location.href = "<c:url value='/signUpInfoIndividual.do'/>";
		}
	</script>
</body>
</html>
